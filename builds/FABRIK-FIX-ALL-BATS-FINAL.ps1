# ============================================
# [.SYSTEMS.T.SYSTEMS.] FABRIK - Fix All BATs FINAL
# ============================================
...
Write-Host "[.SYSTEMS.T.SYSTEMS.] FABRIK - FIX ALL BATS FINAL" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
...
foreach ($batFile in $batFiles) {
    ...
    # Entferne pause-Befehle (alle Varianten)
    ...
    if ($modified) {
        try {
            # UTF8 ohne BOM fuer Windows-Kompatibilitaet
            $utf8NoBom = New-Object System.Text.UTF8Encoding $false
            [System.IO.File]::WriteAllText($batFile.FullName, $content, $utf8NoBom)
